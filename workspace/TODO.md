...
<todo>
Pages Partenaires & Actualités
Reconstruire BCAPartenairesPage (logos + descriptions) et BCAActualitesPage (articles complets) avec vrai contenu.
</todo>

<todo>
Activer le surlignage de section active dans le nav
Utiliser IntersectionObserver pour mettre en surbrillance le lien nav correspondant à la section visible.
</todo>
