  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "odoo_ui_icons": ["odoo_ui_icons", "ui-sans-serif", "system-ui", "sans-serif", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"],
        "chivo": ["Inter", "ui-sans-serif", "system-ui", "sans-serif"]
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
